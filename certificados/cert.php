...
<div id="corpo">
       ...
       <div id="cabecalho">
        ...
        <ul>
			...
			<li class='has-sub'> <a href='../anais'>Edições Anteriores</a></li>  
      ...
      <div id="texto">
        <fieldset>
            <legend>Certificado como participação painel, ou oral.</legend> </br>
    	       <form id="certificado" name="certificado" method="post" action="certificado.php" >		
			    <div>
                    <center><a>Digite o e-mail cadastrado no sistema:</a></center></br>
                    <center><input type="text" id="email" name="email" size="50" maxlength="65" /></center>
                </div></center>
			    <div class="button">
