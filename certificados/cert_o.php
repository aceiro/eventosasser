      ...
      <div id="texto">
        <fieldset>
            <legend>Certificado como participação painel, ou oral.</legend> </br>
    	       <form id="certificado" name="certificado" method="post" action="certificado_o.php" >		
			    <div>
                    <center><a>Digite seu RA:</a></center></br>
                    <center><input type="text" id="ra" name="ra" size="15" maxlength="9" /></center>
                </div></center>
			    <div class="button">
