        ...
        <div style="height: 150px; width: 33%; float: left; omargin-left: 33%;">
            <fieldset style="background-color: #e6EEEE; width: 80%">
                <form id="confirma-pagamento"
                      ...
                      action="../relatorios/lista_resumos_x_autores.php"  novalidate="novalidate">
                    <div class="text-align-center">
                        <br/>
                        <div><img src="../imagens/articles.png" height="70px" width="70px"></div>
                        <div class="text-align-center">
                            <input class="button button-center" name="resumo" type="submit" id="resumo" value="Avaliar Resumo" />
                        </div>
                    </div>
                </form>
            </fieldset>
        ...
        <div style="height: 150px; width: 33%; float: right; margin-left: 33%;">
            <fieldset style="background-color: #e6EEEE; width: 80%">
                <form id="lista-resumos"
                      name="secretaria" method="post"
                      action="../relatorios/lista_geral_inscritos.php"  novalidate="novalidate">
                    <div class="text-align-center">
                        <br/>
