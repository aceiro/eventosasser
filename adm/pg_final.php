...
<div id="corpo">
    ...
    <div id='cssmenu'>
        <ul>
            <li class='active'><a href='pagamento.php'>Voltar</a></li>
        </ul>
    </div>
    ...
    <div style="padding: 50px; margin-bottom: 50px; height: 120px;">
        ...
        <div style="height: 150px; width: 53%; float: left; margin-left: 22%;">
            <fieldset style="background-color: #e6EEEE; width: 80%">
                <form id="lista-resumos"
                      name="secretaria" method="post"
                      action="comprovante.php"  novalidate="novalidate">
                    <div class="text-align-center">
                        <br/>
                        <div class="text-align-center" style="height: 35px;"><strong>Confirmação de Pagamento:</strong></div>
                        <div class="text-align-center" style="height: 35px;">
                            <?php
                                if(strcmp($session->get('msg'),'Pagamento Confirmado')==0){
                                    echo $session->get('msg') . '<br />';
                                    echo 'Nome: ' . $session->get('inscrito');
                                }else{
                                    echo $session->get('msg') . '<br />';
                                }
                            ?>
                        ...
                        <div class="text-align-center">
                            <input class="button button-center" name="resumo" type="submit" id="resumo" value="Gerar compravante e fechar" />
                        </div>
                    </div>
                </form>
            </fieldset>
