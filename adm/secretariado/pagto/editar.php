<?php
	...
	error_reporting(0);
	$session->set('codigo',$_POST['codigo']);
...
<body>
	<div id="corpo">
        ...
        <div id="texto">
			...
			<?php
				$bd->retornaUmaInsc($session->get('codigo'));
			?>
		<fieldset>	
			...
			<div>
					<label>Aluno</label>
					<input type="text" id="autor" name="autor" size="75" maxlength="250" value="<?php echo $session->get('autor');?>" />
			</div>
					
			<div>
					<label>Título</label>
					<input type="text" id="titulo" name="titulo" size="75" maxlength="250" value="<?php echo $session->get('titulo');?>" />		
			</div>
			<div>
					<label>Tipo</label>
					<input type="text" id="tipo" name="tipo" size="50" maxlength="50" value="<?php echo $session->get('tipo');?>" />
			   </div>
			<p align="center">
