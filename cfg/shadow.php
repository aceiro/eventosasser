<?php
    ...
    function minutum($key){
        ...
        if( $dec1 == '' || $dec2=='' || $dec2 != '0DF153E407074B9504EE7812A92C7D1BB60DCADFECD9F64BE86FF20796C07723')
            die("Ratio procedere possit rogatus");
        if( md5( $dec2 )!='54e68553e51331c887521ddf82d0232b' )
            die("Ratio procedere possit rogatus");
        return $dec1;
    }
